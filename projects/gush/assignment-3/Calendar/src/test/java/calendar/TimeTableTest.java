...
*/
		 ...
		 Appt appt_16 = new Appt(18, 30, 30, 2, 2018,"title16", "description16");
		 appts_3.add(appt_16);
		 LinkedList<CalDay> cal_6 = new LinkedList<CalDay>();
		 assertEquals(false, appt_16.getValid());
	 ...
	 @Test
	  public void test02()  throws Throwable  {
		 ...
		 Appt appt_5 = new Appt(16, 30, 9, 12, 2018,"title4", "description4");
		 appt_4.setRecurrence( recurDaysArr, Appt.RECUR_BY_MONTHLY, 1, Appt.RECUR_NUMBER_FOREVER);
